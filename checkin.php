...
<html lang="en">
  ...
  <body>
    <?php
      if ((isset($_POST['confirm'])) && ($_POST['confirm'] == "checkin")) {
    ?>
    <script>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div id="confirmSentError" style="color:red; text-align:center; display:none;"><h3>An error occurred -- please email jdstone@jdstone1.com</h3></div>
          </div>
